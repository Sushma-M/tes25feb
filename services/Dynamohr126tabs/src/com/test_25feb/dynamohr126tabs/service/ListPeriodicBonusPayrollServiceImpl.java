 ...
 */
@Service("Dynamohr126tabs.ListPeriodicBonusPayrollService")
public class ListPeriodicBonusPayrollServiceImpl implements ListPeriodicBonusPayrollService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.ListPeriodicBonusPayrollDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public ListPeriodicBonusPayroll findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding listperiodicbonuspayroll by id: {}" , id);
        ListPeriodicBonusPayroll listperiodicbonuspayroll=this.wmGenericDao.findById(id);
        if(listperiodicbonuspayroll==null){
            LOGGER.debug("No listperiodicbonuspayroll found with id: {}" , id);
    ...
    public ListPeriodicBonusPayroll update(ListPeriodicBonusPayroll updated) throws EntityNotFoundException {
        LOGGER.debug("Updating listperiodicbonuspayroll with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdListPeriodicBonusPayroll();
