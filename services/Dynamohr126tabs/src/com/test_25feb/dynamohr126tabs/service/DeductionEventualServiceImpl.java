 ...
 */
@Service("Dynamohr126tabs.DeductionEventualService")
public class DeductionEventualServiceImpl implements DeductionEventualService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.DeductionEventualDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public DeductionEventual findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding deductioneventual by id: {}" , id);
        DeductionEventual deductioneventual=this.wmGenericDao.findById(id);
        if(deductioneventual==null){
            LOGGER.debug("No deductioneventual found with id: {}" , id);
    ...
    public DeductionEventual update(DeductionEventual updated) throws EntityNotFoundException {
        LOGGER.debug("Updating deductioneventual with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdDeductionEventual();
