...
@Service
public class Dynamohr126tabsQueryExecutorServiceImpl implements Dynamohr126tabsQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Dynamohr126tabsQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("Dynamohr126tabsWMQueryExecutor")
