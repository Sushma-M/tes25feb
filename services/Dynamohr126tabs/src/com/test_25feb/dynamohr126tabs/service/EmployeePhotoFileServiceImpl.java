 ...
 */
@Service("Dynamohr126tabs.EmployeePhotoFileService")
public class EmployeePhotoFileServiceImpl implements EmployeePhotoFileService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.EmployeePhotoFileDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public EmployeePhotoFile findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding employeephotofile by id: {}" , id);
        EmployeePhotoFile employeephotofile=this.wmGenericDao.findById(id);
        if(employeephotofile==null){
            LOGGER.debug("No employeephotofile found with id: {}" , id);
    ...
    public EmployeePhotoFile update(EmployeePhotoFile updated) throws EntityNotFoundException {
        LOGGER.debug("Updating employeephotofile with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdEmployeePhotoFile();
