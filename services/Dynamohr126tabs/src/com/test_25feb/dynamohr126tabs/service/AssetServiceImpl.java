 ...
 */
@Service("Dynamohr126tabs.AssetService")
public class AssetServiceImpl implements AssetService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.AssetDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public Asset findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding asset by id: {}" , id);
        Asset asset=this.wmGenericDao.findById(id);
        if(asset==null){
            LOGGER.debug("No asset found with id: {}" , id);
    ...
    public Asset update(Asset updated) throws EntityNotFoundException {
        LOGGER.debug("Updating asset with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdAsset();
