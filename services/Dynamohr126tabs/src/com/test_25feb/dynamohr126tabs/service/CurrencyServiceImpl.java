 ...
 */
@Service("Dynamohr126tabs.CurrencyService")
public class CurrencyServiceImpl implements CurrencyService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.CurrencyDao")
    ...
    public Currency create(Currency currency) {
        LOGGER.debug("Creating a new currency with information: {}" , currency);
        return this.wmGenericDao.create(currency);
    }
    ...
    public Page<Currency> findAll(QueryFilter[] queryFilters, Pageable pageable) {
        LOGGER.debug("Finding all currencys");
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public Currency findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding currency by id: {}" , id);
        Currency currency=this.wmGenericDao.findById(id);
        if(currency==null){
            LOGGER.debug("No currency found with id: {}" , id);
    ...
    public Currency update(Currency updated) throws EntityNotFoundException {
        LOGGER.debug("Updating currency with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdCurrency();
