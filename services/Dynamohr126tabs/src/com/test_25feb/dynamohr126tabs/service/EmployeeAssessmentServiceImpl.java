 ...
 */
@Service("Dynamohr126tabs.EmployeeAssessmentService")
public class EmployeeAssessmentServiceImpl implements EmployeeAssessmentService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.EmployeeAssessmentDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public EmployeeAssessment findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding employeeassessment by id: {}" , id);
        EmployeeAssessment employeeassessment=this.wmGenericDao.findById(id);
        if(employeeassessment==null){
            LOGGER.debug("No employeeassessment found with id: {}" , id);
    ...
    public EmployeeAssessment update(EmployeeAssessment updated) throws EntityNotFoundException {
        LOGGER.debug("Updating employeeassessment with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdEmployeeAssessment();
