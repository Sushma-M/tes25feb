 ...
 */
@Service("Dynamohr126tabs.EmployeeGeneralDetailService")
public class EmployeeGeneralDetailServiceImpl implements EmployeeGeneralDetailService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.EmployeeGeneralDetailDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public EmployeeGeneralDetail findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding employeegeneraldetail by id: {}" , id);
        EmployeeGeneralDetail employeegeneraldetail=this.wmGenericDao.findById(id);
        if(employeegeneraldetail==null){
            LOGGER.debug("No employeegeneraldetail found with id: {}" , id);
    ...
    public EmployeeGeneralDetail update(EmployeeGeneralDetail updated) throws EntityNotFoundException {
        LOGGER.debug("Updating employeegeneraldetail with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdEmployeeGeneralDetail();
