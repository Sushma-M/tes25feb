 ...
 */
@Service("Dynamohr126tabs.ListCommissionPayrollService")
public class ListCommissionPayrollServiceImpl implements ListCommissionPayrollService {
    ...
    @Autowired
    @Qualifier("Dynamohr126tabs.ListCommissionPayrollDao")
    ...
    @Transactional(readOnly = true, value = "Dynamohr126tabsTransactionManager")
    @Override
    public ListCommissionPayroll findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding listcommissionpayroll by id: {}" , id);
        ListCommissionPayroll listcommissionpayroll=this.wmGenericDao.findById(id);
        if(listcommissionpayroll==null){
            LOGGER.debug("No listcommissionpayroll found with id: {}" , id);
    ...
    public ListCommissionPayroll update(ListCommissionPayroll updated) throws EntityNotFoundException {
        LOGGER.debug("Updating listcommissionpayroll with information: {}" , updated);
        this.wmGenericDao.update(updated);

        Integer id = (Integer)updated.getIdListCommissionPayroll();
