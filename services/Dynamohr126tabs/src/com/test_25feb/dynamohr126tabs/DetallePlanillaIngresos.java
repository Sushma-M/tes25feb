...
/**
 * DetallePlanillaIngresos generated by hbm2java
 */
@Entity
@Table(name="`detalle_planilla_ingresos`"
)
@IdClass(value=DetallePlanillaIngresosId.class)
public class DetallePlanillaIngresos  implements java.io.Serializable {
    ...
    public DetallePlanillaIngresos() {
    }
    ...
    @Column(name="`type?`", nullable=false, insertable=false, updatable=false, length=22)
    ...
    @Column(name="`description?`", insertable=false, updatable=false, length=50)
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof DetallePlanillaIngresos) )
		    return false;

		 DetallePlanillaIngresos that = (DetallePlanillaIngresos) o;
